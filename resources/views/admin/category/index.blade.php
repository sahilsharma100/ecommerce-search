    ...
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
            <div class="mr-auto d-lg-block">
                <a type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#add-category-modal"
                    class="btn btn-primary btn-rounded">+ Add New Category</a>
                            ...
                            <form method="post" action="{{ route('admin.category.store') }}">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-default category" id="category"
                                            name="title" required placeholder="Enter category">
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex">
                                            @if ($list->trashed())
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Restore"
                                                    data-url="{{ route('admin.category.restore', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.category.permanent-delete', $encoded_id) }}"
                                            ...
                                            @else
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Edit"
                                                    data-url="{{ route('admin.category.edit', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.category.delete', $encoded_id) }}"
                                                    data-type="delete" data-reload="true"
