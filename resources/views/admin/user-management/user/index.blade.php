                            ...
                            <form method="post" action="{{ route('admin.user-management.user.store') }}">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-default user" id="user"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            @else
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.user-management.user.delete', $encoded_id) }}"
                                                    data-type="delete" data-reload="true"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.success) {
                                ...
                                if (type == "edit") {
                                    $("#edit-role").empty().append(data.data);
