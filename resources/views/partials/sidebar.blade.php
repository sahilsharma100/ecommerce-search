    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            @auth('admin')
                ...
                <li>
                    <a href="{{ route('admin.product.index') }}" class="ai-icon" aria-expanded="false">
                ...
                <li>
                    <a href="{{ route('admin.category.index') }}" class="ai-icon" aria-expanded="false">
            ...
            @auth('web')
                <li>
                    <a href="{{ route('client.dashboard') }}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">Dashboard</span>
                    </a>
                </li>
        ...
        {{-- <div class="copyright">
            <p class="fs-14 font-w200"><strong class="font-w400">Custom Dashboard</strong> © @php echo date('Y'); @endphp All
                Rights Reserved</p>
            <p>Made with <i class="fa fa-heart"></i> by Sahil</p>
        </div> --}}
    </div>
</div>
